      ...
      <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-20">
        <div className="text-center mt-4 sm:mt-6">
          <h2 className="text-3xl font-bold text-gray-900">
            Master Web Development with Interactive Learning
          </h2>
          <p className="mt-3 text-gray-600">
            Everything you need to learn by doing—backed by smart guidance.
          </p>
        </div>
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <article className="group rounded-[4px] bg-white p-6 shadow-sm ring-1 ring-gray-100 transition hover:shadow-md">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Engage with hands-on coding exercises and real-time feedback,
            ...
            <div className="mt-4">
              <Button
                asChild
                variant="outline"
                className="border-[#3D8B63] rounded-[4px] text-emerald-700  hover:text-white hover:bg-[#3D8B63]"
              >
          ...
          <article className="group rounded-[4px] bg-white p-6 shadow-sm ring-1 ring-gray-100 transition hover:shadow-md">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Receive personalized guidance and instant code analysis from our
              AI tutor, tailored to your progress.
            </p>
            <div className="mt-4">
              <Button
                asChild
          ...
          <article className="group rounded-[4px] bg-white p-6 shadow-sm ring-1 ring-gray-100 transition hover:shadow-md">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Join a thriving community of developers, get help, share insights,
