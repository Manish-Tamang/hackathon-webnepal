  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto space-y-16">
        {/* Header */}
        <section className="relative mt-4 overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-50 via-white to-emerald-50 border border-emerald-100 shadow-sm">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {topThree.map((user) => (
            <div
              key={user.id}
              className={`border-2 p-8 text-center rounded-2xl transition-all duration-300 hover:shadow-xl ${getPodiumStyle(
                user.rank
              )}`}
            >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 p-8 text-center rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 p-8 text-center rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 p-8 text-center rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
